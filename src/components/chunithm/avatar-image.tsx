	...
	<div className="relative w-full md:w-[300px] h-[300px] md:h-[400px] mb-6 md:mb-0">
		<div className="avatar_base relative w-[300px] h-[400px]">
			<div className="avatar_back">
				<img src={`/assets/avatar/${clothing.back}.png`} alt="Back" />
			</div>
			<div className="avatar_wear">
				<img src={`/assets/avatar/${clothing.wear}.png`} alt="Body" />
			</div>
			...
			<div className="avatar_head">
				<img src={`/assets/avatar/${clothing.head}.png`} alt="Head" />
			</div>
			...
			<div className="avatar_face">
				<img src={`/assets/avatar/${clothing.face}.png`} alt="Face" />
			</div>
			<div className="avatar_item_l">
				<img src={`/assets/avatar/${clothing.item}.png`} alt="Left Accessory" />
			</div>
